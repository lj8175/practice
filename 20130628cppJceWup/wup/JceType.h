...
template<> struct Class<taf::UInt8>  { static std::string name() { return "uint8"; } };
template<> struct Class<taf::UInt16> { static std::string name() { return "uint16"; } };
template<> struct Class<taf::UInt32> { static std::string name() { return "uint32"; } };
