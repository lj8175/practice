...
int CmemSetState::HandleEncode(CAsyncFrame *pFrame,
        CActionSet *pActionSet,
        CMsgBase *pMsg) 
{
    static CmemSetAction SetAction;
    ...
    pAction1->SetIActionPtr((IAction *)&SetAction);
...
int CmemSetState::HandleProcess(CAsyncFrame *pFrame,
        CActionSet *pActionSet,
        CMsgBase *pMsg)
{
