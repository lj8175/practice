...
public final class TpnsUnregisterReqHolder
{
    public TpnsUnregisterReqHolder()
    {
    }
    public TpnsUnregisterReqHolder(TpnsUnregisterReq value)
    {
        this.value = value;
    }

    public TpnsUnregisterReq value;
}
