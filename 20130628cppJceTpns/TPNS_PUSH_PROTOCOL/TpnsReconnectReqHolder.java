...
public final class TpnsReconnectReqHolder
{
    public TpnsReconnectReqHolder()
    {
    }
    public TpnsReconnectReqHolder(TpnsReconnectReq value)
    {
        this.value = value;
    }

    public TpnsReconnectReq value;
}
