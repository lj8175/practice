...
public final class TpnsReconnectRspHolder
{
    public TpnsReconnectRspHolder()
    {
    }
    public TpnsReconnectRspHolder(TpnsReconnectRsp value)
    {
        this.value = value;
    }

    public TpnsReconnectRsp value;
}
