...
namespace TPNS_PUSH_PROTOCOL
{
    ...
    static int struct_UUID_unpack__(uint8_t * pui_buff, int32_t * pi_buff_len, UUID * pst_struct, pdu_protocol_header * pdu_header, uint8_t * pui_mapbuff, int32_t * pi_mapbuff_len)
    {
        try
        {
            int i_ret = 0;
    ...
    {
        return struct_UUID_unpack__(pui_buff, pi_buff_len, pst_struct, pdu_header, NULL, NULL);
    }
    ...
    {
        return struct_UUID_unpack__(pui_buff, pi_buff_len, pst_struct, pdu_header, pui_mapbuff, pi_mapbuff_len);
    }
