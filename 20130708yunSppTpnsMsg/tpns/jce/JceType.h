...
template<> struct Class<taf::UInt8>  { static std::string name() { return "short"; } };
template<> struct Class<taf::UInt16> { static std::string name() { return "int32"; } };
template<> struct Class<taf::UInt32> { static std::string name() { return "int64"; } };
