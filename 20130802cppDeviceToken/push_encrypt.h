...
public:
    ...
    */
     ...
     *random used to set iv
    */
    static int AES_Encrypt(const char *key, const char *str, int strLen, char* enStr, int random);
    static int AES_Decrypt(const char *key, const char *str, int strLen, char* deStr, int random);
};
