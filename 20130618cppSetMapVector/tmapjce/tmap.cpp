...
namespace TEST_JEC_MAP
{
    ...
    static int struct_tmap_unpack__(uint8_t * pui_buff, int32_t * pi_buff_len, tmap * pst_struct, pdu_protocol_header * pdu_header, uint8_t * pui_mapbuff, int32_t * pi_mapbuff_len)
    {
        try
        {
            int i_ret = 0;
    ...
    {
        return struct_tmap_unpack__(pui_buff, pi_buff_len, pst_struct, pdu_header, NULL, NULL);
    }
    ...
    {
        return struct_tmap_unpack__(pui_buff, pi_buff_len, pst_struct, pdu_header, pui_mapbuff, pi_mapbuff_len);
    }
